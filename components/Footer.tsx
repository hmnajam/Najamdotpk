/**
 * v0 by Vercel.
 * @see https://v0.dev/t/HUiS35CXfHQ
 */
    ...
    return (
      <footer className="bg-[#111827] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-700 pt-8 pb-4 flex flex-col lg:flex-row justify-between text-xs">
            <span>© 2023 Najam Saeed. All rights reserved</span>
